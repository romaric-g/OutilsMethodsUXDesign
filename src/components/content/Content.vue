<template>
    <main>
        <div class="entretiens" >
            <h1 id="big_titre"> ENTRETIENS </h1>
            <hr>
            <div class="box">
                <div><img src="../../assets/img/entretiens.png" alt="Entretiens"></div>
                <div class="decalement">            
                    ...
                    <div class="box">
                        <div class="limite1"> En amont de l’entretien, préparez des questions. Veillez à ce qu’elles soient suffisamment ouverte, pour obtenir un grand nombre d’informations ( un simple oui ou non n’est pas très constructif )
                        </div>
                        <div class="limite2">
                    ...
                    <div class="box2">
                        ...
                        <div class="inter-box">
                            ...
                            <g id="Icon_feather-info" data-name="Icon feather-info" transform="translate(-1.5 -1.5)">
                                <path id="Tracé_173" data-name="Tracé 173" d="M33,18A15,15,0,1,1,18,3,15,15,0,0,1,33,18Z" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                                <path id="Tracé_174" data-name="Tracé 174" d="M18,24V18" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                                <path id="Tracé_175" data-name="Tracé 175" d="M18,12h0" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                            </g>
                            </svg>
